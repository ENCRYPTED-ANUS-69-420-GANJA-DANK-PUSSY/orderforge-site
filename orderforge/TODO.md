...
## Immediate
- [x] Create Payhip account
- [x] Set up Orderforge storefront
- [x] Build Desk Reset Kit contents
- [x] Build product previews
- [x] Launch first listing draft
- [x] Publish Desk Reset Kit
- [x] Publish Workshop Starter Pack
