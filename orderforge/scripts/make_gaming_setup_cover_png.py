...
out = Path('/home/matt/.openclaw/workspace/orderforge/products/gaming-setup-organizer-pack/build/orderforge-gaming-setup-cover.png')
...
d.text((140,300),'Gaming Setup\nOrganizer Pack',fill='#111827',font=big,spacing=8)
d.text((140,455),'Printable tools for cleaner desks, charging zones, and accessory storage.',fill='#374151',font=mid)
...
d.text((175,620),'• Setup planner',fill='#4b5563',font=small)
d.text((175,658),'• Cable map',fill='#4b5563',font=small)
d.text((175,696),'• Accessory inventory',fill='#4b5563',font=small)
d.rounded_rectangle((640,530,1460,730),radius=18,fill='#111827')
d.text((690,610),'Less cable nest. More usable desk.',fill='#ffffff',font=mid)
